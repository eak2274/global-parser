-- ==========================================================
-- СКРИПТ СОЗДАНИЯ БАЗЫ ДАННЫХ (Версия 3.0 - Нормализованная)
-- ОПАСНО: Полностью удаляет схему 'public' и все ее содержимое!
-- ==========================================================
...
-- ============================================================================
-- TEAMS (Вернулись к нормализованному виду)
-- ============================================================================
...
COMMENT ON TABLE teams IS 'Basketball teams. Each team is a unique entity.';
COMMENT ON COLUMN teams.id IS 'Unique internal identifier';
COMMENT ON COLUMN teams.src_id IS 'External identifier from the data source. Globally unique.';
...
-- ============================================================================
-- TOURNAMENT_TEAMS (Новая связующая таблица для связи "многие-ко-многим")
-- ============================================================================
...
COMMENT ON TABLE tournament_teams IS 'Junction table linking tournaments and their participating teams.';
...
-- ==========================================================
-- ГОТОВО! База данных пересоздана с нормализованной структурой.
-- ==========================================================